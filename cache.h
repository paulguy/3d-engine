...
#define TEXMEM (65536)
#define TEXSLOTS (TEXMEM / LARGE_TEX_SIZE)

typedef int (* get_graphic_dim_t)(unsigned char number);
typedef int (* load_graphic_t)(unsigned char number, unsigned char *data);
